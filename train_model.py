...
def train_model():
    try:
        ...
        categorical_values = {col: sorted(data[col].unique().tolist()) for col in categorical_columns}
        ...
        crop_stats = {"means": crop_means.to_dict(), "stds": crop_stds.to_dict()}
        ...
        model = RandomForestRegressor(
            n_estimators=100, max_depth=None, min_samples_split=2, min_samples_leaf=1, random_state=42, n_jobs=-1
        )
        ...
        return {
            ...
            "metrics": {"train_mse": train_mse, "test_mse": test_mse, "train_r2": train_r2, "test_r2": test_r2},
        }
    except Exception as e:
